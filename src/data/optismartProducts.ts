...
export const optismartCatalogProducts: OptismartCatalogProduct[] = [
  ...
  },
  {
    ...
    description: 'Advanced triple-lens camera for extended monitoring capabilities.',
    retail_price: 100000,
    ...
    source_url: 'https://optismart.com.ng/product/triple-lens-camera/',
  },
  {
    name: 'Four Lens Camera',
    description: 'Professional grade four-lens camera for 360-degree security.',
    retail_price: 150000,
    ...
    source_url: 'https://optismart.com.ng/product/four-lens-camera/',
  },
]
